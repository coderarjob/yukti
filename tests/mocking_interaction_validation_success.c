...
{
    YT_MUST_NEVER_CALL (func_extern_2, YT_V (0),
                        YT_V (2)); // func_extern_2(1, 0), func_extern_2(0, 1) was called.
    YT_MUST_NEVER_CALL (func_extern_1, _, YT_V (0)); // func_extern_1(0, 1) was called.
    sut_func (0, 1);
...
{
    YT_MUST_CALL_IN_ORDER (func_extern_2, YT_V (1), YT_V (0)); // func_extern_2(1, 0) was called.
    YT_MUST_CALL_IN_ORDER (func_extern_1, _, YT_V (1));        // func_extern_1(0, 1) was called.
    sut_func (0, 1);
...
{
    YT_MUST_CALL_ANY_ORDER (func_extern_1, _, YT_V (1));        // func_extern_1(0, 1) was called.
    YT_MUST_CALL_ANY_ORDER (func_extern_2, YT_V (1), YT_V (0)); // func_extern_2(1, 0) was called.
    sut_func (0, 1);
...
YT_TEST (mock, must_call_any_order_at_least_times)
{
    ...
    YT_MUST_CALL_ANY_ORDER_ATLEAST_TIMES (1, func_extern_1, _, YT_V (1));
    // func_extern_2(1, 0), func_extern_2(1, 0) was called.
    YT_MUST_CALL_ANY_ORDER_ATLEAST_TIMES (2, func_extern_2, _, _);
...
{
    // func_extern_2(1, 0), func_extern_2(1, 0) was called.
    YT_MUST_CALL_IN_ORDER_ATLEAST_TIMES (2, func_extern_2, _, _);
    // func_extern_1(0, 1) was called.
    YT_MUST_CALL_IN_ORDER_ATLEAST_TIMES (1, func_extern_1, _, YT_V (1));
